 ...
 * Output: releases/layers-pane-plus-v{version}.zip
...
const zipPath = join(releasesDir, `layers-pane-plus-v${version}.zip`)

console.log(`Building Layers Pane Plus v${version}...`)
try {
...
console.log(`Package created: releases/layers-pane-plus-v${version}.zip (${sizeMB} MB)`)
